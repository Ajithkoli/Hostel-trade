      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <h3 className="text-2xl font-bold">CampusCart</h3>
            </div>
            <p className="text-base-content/80">
              Your trusted platform for campus commerce. Making student life easier through seamless trading.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/about" className="hover:text-primary transition-colors">About CampusCart</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>+917899921042</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
                <span>R V College of Engineering</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-base-300 mt-12 pt-8 text-center">
          <p className="text-base-content/70">
            © {new Date().getFullYear()} CampusCart. All rights reserved. Designed for Campus Commerce
          </p>
        </div>
      </div>
    </footer>
